...
namespace theatreseeting
{
    public partial class cancellation : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (count == 1)
            {
                ...
                if (comboBox1.SelectedIndex == 0 || comboBox1.SelectedIndex == 1)
                {
                    ...
                    {
                        con.Close();
                        DialogResult res = MessageBox.Show("Emin misiniz?", "Seçim Yapın", MessageBoxButtons.YesNo);
                        if (res == DialogResult.Yes)
                        {
                            ...
                            con.Close();
                            MessageBox.Show("Bilet İade İşlemi Başarıyla Gerçekleştirildi.");
                            this.Close();
                        }
                    }
                    else
                ...
                if (comboBox1.SelectedIndex == 2 || comboBox1.SelectedIndex == 3)
                {
                    ...
                    MessageBox.Show("Yeni Şifre Mail Adresinize Gönderildi");
                    this.Close();
                }
            }
            else
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (NO == 1 || NO == 3)
            {
                H = comboBox2.SelectedIndex +2;
            }
            if (NO == 2 || NO == 4)
            {
                H = comboBox2.SelectedIndex +5;
            }
        }
